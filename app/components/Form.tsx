...
export default function Form({
  ...
  return (
    <form
      className="flex flex-col gap-2 font-primary absolute z-10 bg-slate-100 p-6 rounded-t-lg w-full sm:w-3/4 2xl:w-2/5 left-0 bottom-0 h-[calc(100vh-6rem)] shadow-[0_15px_30px_rgba(0,0,0,0.4),0_5px_15px_rgba(0,0,0,0.2)]"
